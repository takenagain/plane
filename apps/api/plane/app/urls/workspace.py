...
urlpatterns = [
    ...
    path(
        ...
        name="workspace-user-time-analytics-summary",
    ),
    path(
        "workspaces/<str:slug>/user-time-analytics/<uuid:user_id>/charts/",
        UserTimeAnalyticsChartsEndpoint.as_view(),
        name="workspace-user-time-analytics-charts",
    ),
    path(
        "workspaces/<str:slug>/user-time-analytics/<uuid:user_id>/rankings/",
        UserTimeAnalyticsRankingsEndpoint.as_view(),
        name="workspace-user-time-analytics-rankings",
    ),
    path(
        "workspaces/<str:slug>/user-time-analytics/<uuid:user_id>/worklogs/",
        UserTimeAnalyticsWorklogsEndpoint.as_view(),
        name="workspace-user-time-analytics-worklogs",
    ),
    path(
        "workspaces/<str:slug>/user-time-analytics/<uuid:user_id>/comment-signals/",
        UserTimeAnalyticsCommentSignalsEndpoint.as_view(),
        name="workspace-user-time-analytics-comment-signals",
    ),
    path(
        "workspaces/<str:slug>/user-time-analytics/<uuid:user_id>/export/",
        UserTimeAnalyticsExportEndpoint.as_view(),
        name="workspace-user-time-analytics-export",
    ),
    path(
