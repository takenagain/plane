...
For manual or browser-based end-to-end checks (auth, agent FAB, chat sessions, reload), use the runbook in [`docs/agent/test-spec.md`](../../../../docs/agent/test-spec.md) §4. Docker API tests are documented in [`RUNNING_TESTS.md`](./RUNNING_TESTS.md).
