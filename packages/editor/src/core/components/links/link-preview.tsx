  ...
  return (
    ...
    >
      <div className="shadow-md flex items-center gap-3 rounded-sm border-2 border-subtle bg-layer-1 p-2 text-11 text-tertiary">
        <EditorIcon icon={GlobeIcon} width={14} height={14} className="inline-block" />
        ...
        <div className="flex gap-2">
          <button onClick={copyLinkToClipboard} className="cursor-pointer transition-colors hover:text-primary">
            <EditorIcon icon={CopyIcon} width={14} height={14} className="inline-block" />
          </button>
          {editor.isEditable && (
            <>
              <button
              ...
              >
                <EditorIcon icon={EditIcon} width={14} height={14} className="inline-block" />
              </button>
