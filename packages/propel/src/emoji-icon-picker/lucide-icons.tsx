...
export const LUCIDE_ICONS_LIST = [
  ...
  { name: "Codepen", element: Brackets },
  { name: "Codesandbox", element: Package },
  ...
  { name: "Instagram", element: Sparkles },
